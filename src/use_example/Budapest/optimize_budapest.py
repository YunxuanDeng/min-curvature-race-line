"""End-to-end example: optimize and simulate a lap on Budapest circuit.

Usage:
    python src/use_example/Austin/optimize_budapest.py

Requires a TUM-format track CSV at ``src/use_example/Austin/Budapest.csv``.
Produces ``./budapest_summary.png``.
"""
...
# Paths
OUTPUT_DIR = Path("src/use_example/Budapest")
OUTPUT_DIR.mkdir(exist_ok=True)
TRACK_PATH = Path("src/use_example/Budapest/Budapest.csv")
...
out = OUTPUT_DIR / "budapest_summary.png"
